      ...
      <div className="container">
        <article className="row">
          <div className="col-lg-12 text-center skills-title">
            ...
            <p className="para">A skill is an ability to do something well.</p>
            <p>
              With an experience of 3+ years in IT I have developed skills like: Problem Solving,
              Teamwork, Leadership, Analytical Skills.
            </p>
